        ...
        <section className="relative w-full bg-bg py-24 md:py-32 px-6 md:px-12 xl:px-24 border-t border-border overflow-hidden">
            ...
            <div className="relative z-10 max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
                ...
                <div className="w-full lg:w-1/2 flex flex-col">
                    ...
                    >
                        <p>
                            We have been at the forefront of redefining premium real estate. Our philosophy is rooted in the belief that a home is more than a physical space—it is a canvas for life's most precious moments, meticulously crafted to reflect the aspirations of those who reside within.
                        </p>
                        <p>
                            With an unwavering commitment to architectural brilliance, sustainable development, and uncompromising quality, every project we undertake, like Balaji Upvan, is designed to stand the test of time, creating enduring value for families.
                        </p>
                    </motion.div>
